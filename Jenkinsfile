pipeline {
  ...
  stages {
    ...
    stage('Deploy') {
      environment {
        __USERS_API_ENDPOINT_PLACEHOLDER__ = 'http:\\/\\/todo.princeahugah.com:3001\\/api\\/users'
        __TASKS_API_ENDPOINT_PLACEHOLDER__ = 'http:\\/\\/todo.princeahugah.com:3002\\/api\\/tasks'
      }
      steps {
